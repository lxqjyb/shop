  ...
  <div class="order-right">
    <div class="order-content">
      ...
      <div class="choose-order">
        <Pagination :pageNo="page" :totalPages="myOrder.pages" :total="myOrder.total" :continues="5" @getPage="getPage"></Pagination>
      </div>
    </div>
    <!--猜你喜欢-->
    <div class="like">
...
export default {
    ...
    methods:{
      async getData(){
        let result = await this.$API.reqMyOrder(this.page,this.size);
        if(result.code===200){
