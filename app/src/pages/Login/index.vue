          ...
          <div class="content">
            <form action="##">
              ...
              <div class="input-text clearFix">
                ...
                <input placeholder="请输入密码"  v-model="password" name="password" v-validate="{required:true,regex:/^[0-9A-Za-z]{8,20}$/}" :class="{invalid:errors.has('phone')}" />
              </div>
      ...
      async userLogin(){
        try {
          ...
          if(phone&&password){
            ...
            // 登录的路由组件：看路由中是否包含query参数，有：调到query参数指定路由。没有：调到home页
